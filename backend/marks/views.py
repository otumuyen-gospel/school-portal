...
class MarkList(generics.ListCreateAPIView):
    ...
    filter_fields = ('pk','examScore','test_score1','test_score2',
                     'test_score3','subjectId', 'userId',) 

     #you can search using the "search" keyword
    search_fields = ('pk','examScore','test_score1','test_score2',
                     'test_score3','subjectId', 'userId',)

    #you can order using the "ordering" keyword
    ordering_fields = ('pk','examScore','test_score1','test_score2',
                     'test_score3','subjectId', 'userId',)
...
class ApiRoot(generics.GenericAPIView):
    ...
    def get(self, request, *args, **kwargs):
        return Response({'list': reverse(MarkList.name,
            request=request)})
